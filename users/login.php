...
<body>
    ...
    <div class="container-fluid copyright bg-dark py-4">
        <div class="container text-center">
            <p class="mb-2">Copyright &copy; <a class="fw-semi-bold" href="#">Clínica Veterinaria del Norte</a>, All Right Reserved.
            </p>
            <p class="mb-0">Designed By <a class="fw-semi-bold" href="">HTML</a> Distributed
                By: <a href="https://www.facebook.com/Esquivel7809" target="_blank">Veterinaria</a> </p>
        </div>
    </div>
    <!-- Copyright End -->
