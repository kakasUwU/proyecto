...
<body>
    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                ...
                <legend>Registre sus datos necesarios para pedir una cita.</legend>
                    </div>
                </div>
        </div>
        <div class="container">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="col-12 col-md-9">
                            <div class="form-outline mb-4">
                                ...
                                <div class="mb-4">
                                <label for="profesion" class="nav-link"><i class="fas fa-user"></i> &nbsp;<strong>Dirección</strong></label>
                                ...
                                <div class="mb-4">
                                <label for="profesion" class="nav-link"><i class="fas fa-user"></i> &nbsp;<strong>Nombre de tu mascota</strong></label>
                                        <input type="text" value="" onkeyup="mayus(this);" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().!#$%&’*+/=?^_`{|}~-].,\s ]{4,520}" class="form-control" name="profesion" id="profesion" maxlength="90" placeholder="Obligatorio" text-transform="capitalize" required>
