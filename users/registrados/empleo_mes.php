    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-light m-0">
                                    ...
                                    <a href="empleo_mes.php" class="dropdown-item active">Menos de 1 Mes</a>
      ...
      <div>
                <?php  
                    ...
                    {
                        echo "<center><a href='empleo_mes.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='empleo_mes.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='empleo_mes.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
