...
$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.area = 'Vias y Transporte' ORDER BY cargo LIMIT $empieza, $por_pagina");
$sql1->execute();
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-toolbox" >&nbsp;Áreas</a></i>
                                <div class="dropdown-menu bg-light m-0">
                                    ...
                                    <a href="empleo_vias.php" class="dropdown-item active">Vías y Transporte</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
