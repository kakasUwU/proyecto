...
$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.cargo = 'Mandos Intermedios' ORDER BY oferta.cargo LIMIT $empieza, $por_pagina");
$sql1->execute();
    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                <div class="row gy-5 gx-4">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fas fa-user-tie" >&nbsp;Cargo</a></i>
                                <div class="dropdown-menu bg-light m-0">
                                    <a href="empleo_directivo.php" class="dropdown-item ">Directivos</a>
                                    <a href="empleo_obra.php" class="dropdown-item">Responsable Obra</a>
                                    <a href="empleo_ejecucion.php" class="dropdown-item">Técnicas de Ejecución</a>
                                    <a href="empleo_mandos.php" class="dropdown-item active">Mandos Intermedios</a>
                                    <a href="empleo_mandosad.php" class="dropdown-item ">Mandos Administrativos</a>
                                    <a href="empleo_operarios.php" class="dropdown-item">Operarios</a>
                                    <a href="empleo_ventas.php" class="dropdown-item">Marketing y Ventas</a>
                                    <a href="empleo_software.php" class="dropdown-item">Operario Software</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
      ...
      <div>
                <?php  
                    $sql = $con->prepare("SELECT COUNT(*) FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.cargo = 'Mandos Intermedios' ORDER BY oferta.cargo");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='empleo_mandos.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='empleo_mandos.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='empleo_mandos.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
