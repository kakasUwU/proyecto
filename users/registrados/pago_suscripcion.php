            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="pago_suscripcion.php" class="dropdown-item active">Suscripción</a>
        ...
        <div class="container ">
            ...
            <div class="row gy-5 gx-5 "  >
                        ...
                        <div class="col " >
                            ...
                            <button type="button" class="btn btn-secondary"><p>Pago Suscripción</p></button><br>
                               
                                
                                <img src="../../img/suscripcion.png" width="397" height="510" class="rounded mx-auto d-block"></img>
                                
                                <div class="card-body">
                                <h5 class="card-title">
                                    <p class="text-center">Obtenga acceso a la Bolsa de empleo pagando una suscripción anual por $39.999 </p></h5>
           ...
           <form method="post" action="pago_paypal_suscripcion.php">
