...
<body>
            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="hv.php" class="dropdown-item active">Hoja de Vida</a>
    ...
    <!-- Page Header End -->
        <div class="container ">
            ...
            <div class="row gy-5 gx-5 "  >
                        ...
                        <div class="col " >
                            ...
                            <button type="button" class="btn btn-secondary"><p>Pago Suscripción Mentorias</p></button><br>
                                ...
                                <img src="../../img/SERVICIO1.png" width="397" height="510" class="rounded mx-auto d-block"></img>
                                
                                <div class="card-body">
                                <h5 class="card-title">
                                    <p class="text-center">Obtenga acceso a Mentorias para tu Hoja de Vida pagando una suscripción anual por $49.999 </p></h5>
           ...
           <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
                        <?php 
                            $documento;
                            $detalle = "Pago Suscripcion hoja de vida";
                            $precio = 49999;
           ...
           <form method="post" action="pago_paypal_hv.php">
