...
$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.tip_cotra = 'Termino Fijo' ORDER BY cargo LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<body>
        ...
        <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
            <div class="row gy-5 gx-4">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown">Cargo</a>
                        <div class="dropdown-menu bg-light m-0">
                    ...
                    <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-book" >&nbsp;Tipo Contrato</a></i>
                        <div class="dropdown-menu bg-light m-0">
                            <a href="empleo_tfijo.php" class="dropdown-item active">Termino Fijo</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"></i>Rango Salarial</a>
                        <div class="dropdown-menu bg-light m-0">
                    ...
                    <div class="col">
                        <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <?php echo 'Requisitos' . '  ' . ($row['anio_exper']); ?> Años Experiencia<br><br><br>
    ...
    <div>
        <?php
        $sql = $con->prepare("SELECT COUNT(*) FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.tip_cotra = 'Termino Fijo' ORDER BY cargo");
        $sql->execute();
        ...
        if ($total_paginas == 0) {
            ...
            echo "<center><a href='empleo_tfijo.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
            for ($i = 1; $i <= $total_paginas; $i++) {
                echo "<a href='empleo_tfijo.php?pagina=" . $i . "'> " . $i . " </a>";
            }
            echo "<a href='empleo_tfijo.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
        }
        ?>
            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex pt-3">
                        <a target="_blank" class="btn btn-square btn-primary rounded-circle me-2" href="https://www.instagram.com/friendconstructorsas/"><i class="fab fa-instagram"></i></a>
                        <a target="_blank" class="btn btn-square btn-primary rounded-circle me-2" href="https://www.facebook.com/profile.php?id=100088458352909"><i class="fab fa-facebook-f"></i></a>
