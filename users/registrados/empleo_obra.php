...
$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.cargo = 'Responsable de Obra' ORDER BY oferta.cargo LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<body>
    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-light m-0">
                                    ...
                                    <a href="empleo_ti.php" class="dropdown-item"> activeTermino Indefinido</a>
                ...
                <?php foreach($resultado1 as $row) {?>             
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <img src="../../img/proyectos/empleos/<?php echo $row['img_empr']; ?>" width="357" height="210" alt="Imagen Empresa"></img>
      ...
      <div>
                <?php  
                    $sql = $con->prepare("SELECT COUNT(*) FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.cargo = 'Responsable de Obra' ORDER BY oferta.cargo");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='empleo_obra.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='empleo_obra.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='empleo_obra.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
