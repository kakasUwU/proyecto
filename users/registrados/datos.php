...
<form class="dashboard-container FormularioAjax" method="POST" data-form="save" data-lang="es" autocomplete="off" action="save_hv.php" enctype="multipart/form-data" >
        ...
        <fieldset class="mb-4">
            <legend><i class="far fa-comment-dots"></i> &nbsp; Foto</legend>
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="form-outline mb-4">
                        <img src="../../img/proyectos/user/<?php echo $row_user['image']; ?>" width="250" height="250"></img>
                        ...
                        <div class="col-12 col-md-9">
                            <div class="form-outline mb-4">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" pattern="[0-9]{10,10}" class="form-control" name="phone" id="phone" maxlength="10" value="<?php echo $row_user['phone'] ?>" readonly>
                                </div>
                                </div>

                                <div class="mb-4">
                                <label for="profesion" class="nav-link"><i class="fas fa-user"></i> &nbsp;<strong>Profesión</strong></label>
                                        <input type="text" onkeyup="mayus(this);" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().!#$%&’*+/=?^_`{|}~-].,\s ]{4,520}" class="form-control" name="profesion" id="profesion" maxlength="90" text-transform="capitalize" value="<?php echo $row_user['profesion'] ?>" readonly >
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-outline mb-4">
                            <div class="mb-4">
                                    ...
                                    <input type="email"  onkeyup="minus(this);" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" class="form-control" name="email" id="email" maxlength="40" value="<?php echo $row_user['email'] ?>" readonly>
                            </div>
                        </div>
        ...
        <fieldset class="mb-4">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="form-outline mb-4">
                            <textarea pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\s ]{4,520}" class="form-control" name="desc_perfil" id="desc_perfil" maxlength="400" rows="7" readonly><?php echo $row_user['desc_perfil'] ?></textarea>
        ...
        <fieldset class="mb-4">
                <legend><i class="far fa-file-image"></i> &nbsp;  Hoja de Vida en PDF</legend>
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12 col-md-5">
                        <a href="ver_hoja_vida.php?id=<?php echo $row_user['document']; ?>&token=<?php echo hash_hmac('sha1', $row_user['document'], KEY_TOKEN); ?>" class="btn btn-primary">Ver Hoja de Vida</a>
