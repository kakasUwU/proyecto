...
<head>
    <meta charset="utf-8">
    <title>Asesoria pruebas pscotecnicas ibague </title>
...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-6">
                <h4>QR PAGO MENTORIAS PRUEBAS PSICOTECNICAS </h4><br>
                    <!-- <div id="paypal-button-container"></div> -->
                    <div>
                        <img src="../../img/CODIGOSQR/MENTORIAS/PRUEBAS/PRUEBAS.png" height="245">
                    </div>
                </div>
