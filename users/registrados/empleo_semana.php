...
$fh = date("Y-m-d");
$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.date_publi >= '$nueva' AND oferta.date_publi <= '$fh' ORDER BY oferta.cargo LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<body>
   ...
   <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-light m-0">
                                    ...
                                    <a href="empleo_semana.php" class="dropdown-item active">Hace 1 Semana</a>
      ...
      <div><br>
                <?php  
                    $sql = $con->prepare("SELECT COUNT(*) FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' AND oferta.date_publi >= '$nueva' AND oferta.date_publi <= '$fh' ORDER BY oferta.cargo");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='empleo_semana.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='empleo_semana.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='empleo_semana.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
