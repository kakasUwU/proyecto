...
$query_usuarios=$con->prepare ("SELECT * FROM tm_usuario, tr_tipo_usuario WHERE cc_usu = '1123764903".$_SESSION['usuario']."' AND tm_usuario.ID_tip_usu = tr_tipo_usuario.ID_tip_usu");
...
#$sql1 = $con->prepare("SELECT * FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart WHERE oferta.estado_empleo = 'Activo' ORDER BY cargo LIMIT $empieza, $por_pagina");
#$sql1->execute();
...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h3 class="text-white animated slideInRight">Bolsa de Empleo</h3>
           <!--
    ...
    <div class="container-fluid" style="border-top: 1px solid #E1E1E1; padding: 20px; ">
                <div class="row gy-5 gx-4">
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-3">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="far fa-calendar-alt" >&nbsp;</i>Fecha </a>
                                <div class="dropdown-menu bg-light m-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-toolbox" >&nbsp;</i>Áreas</a>
                                <div class="dropdown-menu bg-light m-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-address-card" >&nbsp;</i>Experiencia</a>
                                <div class="dropdown-menu bg-light m-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-book" >&nbsp;</i>Tipo Contrato</a>
                                <div class="dropdown-menu bg-light m-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-dollar-sign" >&nbsp;</i>Rango Salarial</a>
                                <div class="dropdown-menu bg-light m-0">
                            ...
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle " data-bs-toggle="dropdown"><i class="fas fa-graduation-cap" >&nbsp;</i>Estudios Requeridos</a>
                                <div class="dropdown-menu bg-light m-0">
      ...
      <div>
                <?php  
                    $sql = $con->prepare("SELECT COUNT(*) FROM oferta LEFT OUTER JOIN municipios ON oferta.id_ciu = municipios.id_municipio LEFT OUTER JOIN depar ON municipios.departamento_id = depar.id_depart ORDER BY cargo");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='b_empleo.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='b_empleo.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='b_empleo.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>311 2228 877</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>expertobra@gmail.com</p>
                    <div class="d-flex pt-3">
                        <a target="_blank" class="btn btn-square btn-primary rounded-circle me-2" href="#"><i
                                class="fab fa-instagram"></i></a>
                        <a target="_blank" class="btn btn-square btn-primary rounded-circle me-2" href="#"><i
                                class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square btn-primary rounded-circle me-2" href="https://api.whatsapp.com/send?phone=3112228877" target="_blank"><i class="fab fa-whatsapp"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fas fa-copyright"></i> Copyright Expertobra  2023</p>
