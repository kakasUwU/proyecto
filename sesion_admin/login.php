...
<body>
    ...
    <div class="container" align="center">
        <fieldset class="mb-4">
            <legend><i class="fas fa-user" ></i> &nbsp; INICIO DE SESION ADMINISTRADOR</legend>
                <form role="form" class="form-horizontal" method="post" name="form1" id="form1" action="includes/inicio.php" autocomplete="off">
                    ...
                    <div class="form-group" align="center">
                        <a href=""><h6>Recuperar Contrase&ntilde;a</h6></a>
                    </div>
                    <div class="form-group" align="center">
    ...
    <div class="container-fluid copyright bg-dark py-4">
        <div class="container text-center">
            <p class="mb-2">Copyright &copy; <a class="fw-semi-bold" href="#">Friend Constructor</a>, All Right Reserved.
            </p>
