...
$sql1 = $con->prepare("SELECT * FROM compra ORDER BY fecha LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        <a href="reporte_cursos.php" class="dropdown-item active">Pago Cursos</a>
            ...
            <?php foreach ($resultado1 as $row) { ?>
                <div class="card shadow-sm">
                    <div class="row">
                        ...
                        <div class="col">
                            <p style="font-size: 15px">
                                <?php echo $row['nom'] ?>&nbsp;<?php echo $row['ape'] ?>
                            </p>
                        </div> 
                        <div class="col">
                            <p style="font-size: 15px">
                                <?php echo moneda . number_format($row['total']) ?>
                            </p>
                        </div>
    ...
    <div>
                <?php  
                    $sql = $con->prepare("SELECT COUNT(*) FROM compra ORDER BY fecha");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='reporte_cursos.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='reporte_cursos.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='reporte_cursos.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
