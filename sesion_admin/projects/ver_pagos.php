...
$sql1 = $con->prepare("SELECT * FROM `pago_suscr` INNER JOIN user ON pago_suscr.documento = user.document WHERE user.activo = 'Activo' ORDER BY user.document LIMIT $empieza, $por_pagina");
$sql1->execute();
...
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-0 pe-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="ver_pagos.php" class="dropdown-item active">Ver Pagos</a>
                    </div>
                </div>
    ...
    <div>
                <?php   
                    $sql = $con->prepare("SELECT COUNT(*) FROM `pago_suscr` INNER JOIN user ON pago_suscr.documento = user.document WHERE user.activo = 'Activo' ORDER BY user.document");
                    $sql->execute();
                    ...
                    {
                        echo "<center><a href='ver_pagos.php?pagina=1'>" . "<i class='fa fa-arrow-left'></i>" . "</a>";
                        for ($i = 1; $i <= $total_paginas; $i++) 
                        {
                            echo "<a href='ver_pagos.php?pagina=" . $i . "'> " . $i . " </a>";
                        }
                        echo "<a href='ver_pagos.php?pagina=$total_paginas'>" . "<i class='fa fa-arrow-right'></i>" . "</a></center>";
                    }
                ?>
